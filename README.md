...
- **실습 느낌**:
  - 여름방학 때 특강으로 DB에 관련된 내용을 간단하게 배웠지만 그럼에도 불구하고 직접 만들어 보며 신기하였습니다.
...
- **실습 느낌**:
  - 예외 처리를 배우며 오류 발생 시 안정성을 확보한 것 같앗습니다.
...
- **실습 느낌**:
  - 현재 게시글의 수정과 삭제처리 방법을 알게되었고 연습 문제에서 조금 해매기는 했지만 해결했습니다.
...
- **실습 느낌**:
  - DB를 통해 다양한 정보를 자동으로 생성하는 방법을 배운 것 같습니다.
...
- **실습 느낌**:
  - 로그인 처리(2)을 배우며 로그인/로그아웃 기능과 뒤로 돌아갈 때 사용자 제한 등 다양한 기능을 알게되었습니다.
...
- **실습 느낌**:
  - 마지막 주차를 하며 다중 사용자의 로그인 기술에 대해 알게되었습니다.
